...
container = client.containers.run('michzimm/redfish_sim', command='python /usr/src/app/redfishMockupServer.py -H "0.0.0.0"', volumes=['/root/redfish_simgen/instances/'+instance_name])